const projects = [
  {
    ...
    files: [
      { name: "Pay To Mart Landing.Zip", size: "3.25 MB", link: "#" },
      { name: "Pay To Mart Admin.Zip", size: "3.15 MB", link: "#" },
      { name: "Pay To Mart Logo.Zip", size: "2.02 MB", link: "#" },
