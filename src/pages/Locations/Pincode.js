...
function Pincode() {
  ...
  const getAllPincode = () => {
    ...
    axios
      .post(
        "http://16.171.143.201:5025/v1/admin/pincode/getAll",
        {},
        {
  ...
  const addPincode = () => {
    ...
    axios
      .post("http://16.171.143.201:5025/v1/admin/pincode/add", dataArray, {
        headers: { Authorization: `Bearer ${token}` },
      })
      .then(
        res => {
  ...
  const editPincode = () => {
    ...
    axios
      .put(
        "http://16.171.143.201:5025/v1/admin/pincode/edit" + "/" + docid,
        dataArray,
        {
          headers: { Authorization: `Bearer ${token}` },
        }
  ...
  const deletefeature = ds => {
    ...
    axios
      .delete(
        "http://16.171.143.201:5025/v1/admin/pincode/delete" + "/" + remid,
  ...
  return (
    <React.Fragment>
      <div className="page-content">
        <Container fluid>
          {/* Render Breadcrumb */}
          <Breadcrumbs title="Pay To Mart" breadcrumbItem="Pincode List" />{" "}
          <Row>
            <Col md="12">
              {" "}
