...
function States() {
  ...
  const addbrands = () => {
    ...
    axios
      .post("http://16.171.143.201:5025/v1/admin/state/add", dataArray, {
        headers: { Authorization: `Bearer ${token}` },
      })
      .then(
        res => {
  ...
  const editbrands = () => {
    ...
    axios
      .put(
        "http://16.171.143.201:5025/v1/admin/state/edit" + "/" + docid,
        dataArray,
        {
          headers: { Authorization: `Bearer ${token}` },
        }
  ...
  const deletefeature = data => {
    ...
    axios
      .delete(
        "http://16.171.143.201:5025/v1/admin/state/delete" + "/" + remid,
        {
          headers: { Authorization: `Bearer ${token}` },
        }
      )
  ...
  return (
    <React.Fragment>
      <div className="page-content">
        <Container fluid>
          {/* Render Breadcrumb */}
          <Breadcrumbs title="Pay To Mart" breadcrumbItem="States List" />{" "}
          <Row>
            <Col md="12">
              {" "}
