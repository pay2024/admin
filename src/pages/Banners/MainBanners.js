...
function MainBanners() {
  ...
  const AddCategory = () => {
    ...
    axios
      .post("http://16.171.143.201:5025/v1/admin/banners/add", dataArray, {
  ...
  const GetAllCategories = () => {
    ...
    axios
      .post(
        "http://16.171.143.201:5025/v1/admin/banners/getAll",
        {},
        {
          headers: { Authorization: `Bearer ${token}` },
        }
  ...
  const EditCategory = () => {
    ...
    axios
      .put(
        "http://16.171.143.201:5025/v1/admin/banners/edit/" + id,
        dataArray,
        {
          headers: { Authorization: `Bearer ${token}` },
        }
  ...
  const deletes = data => {
    ...
    axios
      .delete(
        "http://16.171.143.201:5025/v1/admin/banners/delete" + "/" + remid,
        {
          headers: { Authorization: `Bearer ${token}` },
        }
      )
  ...
  return (
    <React.Fragment>
      <div className="page-content">
        <Container fluid>
          {/* Render Breadcrumb */}
          <Breadcrumbs title="Pay To Mart" breadcrumbItem="Banner List" />{" "}
          <Row>
            <Col md="12">
              {" "}
