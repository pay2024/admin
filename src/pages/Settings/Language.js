...
const Brand = () => {
  ...
  const addbrands = () => {
    ...
    axios
      .post("http://16.171.143.201:5025/v1/admin/languages/add", dataArray, {
        headers: { Authorization: `Bearer ${token}` },
      })
      .then(
        res => {
  ...
  const editbrands = () => {
    ...
    axios
      .put(
        "http://16.171.143.201:5025/v1/admin/languages/edit" + "/" + docid,
        dataArray,
        {
          headers: { Authorization: `Bearer ${token}` },
        }
  ...
  const deletefeature = data => {
    ...
    axios
      .put(
        "http://16.171.143.201:5025/v1/admin/languages/delete" + "/" + remid,
        {},
        {
          headers: { Authorization: `Bearer ${token}` },
        }
  ...
  return (
    <React.Fragment>
      <div className="page-content">
        <Container fluid>
          <Breadcrumbs title="Pay To Mart" breadcrumbItem="Language" />
          <Row>
            <Col md={4}>
              <Card>
