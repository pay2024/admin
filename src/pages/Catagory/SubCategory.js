...
function SubCategory() {
  ...
  const AddCategory = () => {
    ...
    axios
      .post("http://16.171.143.201:5025/v1/admin/subcategory/add", dataArray, {
  ...
  const EditCategory = () => {
    ...
    axios
      .put(
        "http://16.171.143.201:5025/v1/admin/subcategory/edit/" + id,
        dataArray,
        {
          headers: { Authorization: `Bearer ${token}` },
        }
  ...
  const deletes = data => {
    ...
    axios
      .delete(
        "http://16.171.143.201:5025/v1/admin/subcategory/delete" + "/" + remid,
  ...
  return (
    <React.Fragment>
      <div className="page-content">
        <Container fluid>
          <Breadcrumbs title="Pay To Mart" breadcrumbItem="Sub Category" />{" "}
          <Row>
            <Col md="12">
              {" "}
              ...
              >
                ...
                {/* <Row>
                  ...
                  <Col md={6}>
                    <div className="mb-3">
                      <Label for="basicpill-firstname-input1">
                        SubCategory Title <span className="text-danger">*</span>
                      </Label>
                      <Input
                        type="text"
                        className="form-control"
