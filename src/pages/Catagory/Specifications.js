...
function Specifications() {
  ...
  const AddCategory = () => {
    ...
    axios
      .post("http://16.171.143.201:5025/v1/admin/specifications/add", data, {
  ...
  const EditCategory = () => {
    ...
    axios
      .put(
        "http://16.171.143.201:5025/v1/admin/specifications/edit/" + id,
        data,
        {
          headers: { Authorization: `Bearer ${token}` },
        }
  ...
  const deletes = data => {
    ...
    axios
      .delete(
        "http://16.171.143.201:5025/v1/admin/specifications/delete" +
          "/" +
          remid,
  ...
  return (
    <React.Fragment>
      <div className="page-content">
        <Container fluid>
          <Breadcrumbs title="Pay To Mart" breadcrumbItem="Specifications" />{" "}
          <Row>
            <Col md="12">
              {" "}
