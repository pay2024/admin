...
function Categories() {
  ...
  const AddCategory = () => {
    ...
    axios
      .post("http://16.171.143.201:5025/v1/admin/category/add", dataArray, {
  ...
  const getpopup = data => {
    setform1(data)
    setFormValues1(data.languageCategory)
    tog_small1()
  }
  ...
  const EditCategory = () => {
    ...
    axios
      .put(
        "http://16.171.143.201:5025/v1/admin/category/edit/" + id,
        dataArray,
        {
          headers: { Authorization: `Bearer ${token}` },
        }
  ...
  const deletes = data => {
    ...
    axios
      .delete(
        "http://16.171.143.201:5025/v1/admin/category/delete" + "/" + remid,
        {
          headers: { Authorization: `Bearer ${token}` },
        }
      )
  ...
  return (
    <React.Fragment>
      <div className="page-content">
        <Container fluid>
          <Breadcrumbs title="Pay To Mart" breadcrumbItem="Categories" />{" "}
          <Row>
            <Col md="12">
              {" "}
